...
export function seedXtreino09062026() {
  ...
  const xtreinoJogadoresData = [
    ...
    { date, xtreinoId, teamName: "FURY ROYAL", playerName: "NG", q1Kills: 3, q2Kills: 0, q3Kills: 0, totalKills: 3 },
    { date, xtreinoId, teamName: "FURY ROYAL", playerName: "MARTNA", q1Kills: 6, q2Kills: 10, q3Kills: 12, totalKills: 28 },
    { date, xtreinoId, teamName: "FURY ROYAL", playerName: "NOKI", q1Kills: 0, q2Kills: 10, q3Kills: 7, totalKills: 17 },
