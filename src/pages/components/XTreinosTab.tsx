    ...
    <div>
      ...
      <div className="bg-[#12121a] rounded-xl border border-[#2a2a3a] p-4 mb-6">
        <div className="flex flex-col lg:flex-row gap-4 items-start lg:items-center">
          ...
          <div className="flex flex-wrap gap-3 flex-1">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="px-3 py-2 rounded-lg bg-[#1a1a24] border border-[#2a2a3a] text-[#f0f0f5] text-sm focus:outline-none focus:border-red-500/50 min-w-[140px] disabled:opacity-40"
              >
          ...
          {(selectedDate || sortBy !== "total" || selectedMonth) && (
            <button
              onClick={() => { setSelectedDate(""); setSelectedMonth(""); setSortBy("total"); }}
