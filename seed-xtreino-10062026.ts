...
export function seedXtreino10062026() {
  ...
  const xtreinoColocacoesData = [
    ...
    { date, xtreinoId, teamName: "UGD Threat + Olympique", q1Pos: 2, q2Pos: 1, q3Pos: 6 },
    { date, xtreinoId, teamName: "FURY ROYAL", q1Pos: 3, q2Pos: 3, q3Pos: 1 },
    { date, xtreinoId, teamName: "EmE", q1Pos: 4, q2Pos: 2, q3Pos: 10 },
    { date, xtreinoId, teamName: "UGD Legends", q1Pos: 6, q2Pos: 5, q3Pos: 4 },
  ...
  const xtreinoJogadoresData = [
    ...
    { date, xtreinoId, teamName: "UGD Threat + Olympique", playerName: "Buzeira", q1Kills: 3, q2Kills: 2, q3Kills: 1, totalKills: 6 },
    { date, xtreinoId, teamName: "UGD Threat + Olympique", playerName: "Sant", q1Kills: 0, q2Kills: 0, q3Kills: 0, totalKills: 0 },
    { date, xtreinoId, teamName: "UGD Threat + Olympique", playerName: "Hell", q1Kills: 3, q2Kills: 8, q3Kills: 4, totalKills: 15 },
    { date, xtreinoId, teamName: "UGD Threat + Olympique", playerName: "Xoxoto", q1Kills: 14, q2Kills: 13, q3Kills: 4, totalKills: 31 },
    ...
    { date, xtreinoId, teamName: "UGD Legends", playerName: "Sant", q1Kills: 0, q2Kills: 0, q3Kills: 0, totalKills: 0 },
    { date, xtreinoId, teamName: "UGD Legends", playerName: "Waze", q1Kills: 2, q2Kills: 7, q3Kills: 3, totalKills: 12 },
    { date, xtreinoId, teamName: "UGD Legends", playerName: "Kaze", q1Kills: 5, q2Kills: 4, q3Kills: 1, totalKills: 10 },
    { date, xtreinoId, teamName: "UGD Legends", playerName: "Treon", q1Kills: 7, q2Kills: 6, q3Kills: 11, totalKills: 24 },
